              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Connect with verified and experienced pandits for all your
                    spiritual needs. Seamless booking for pujas, ceremonies,
                    and more.
                  </p>
                </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  We've simplified the process of finding and booking a pandit.
                  Follow these simple steps to arrange your next ceremony.
                </p>
              </div>
            </div>
              ...
              <Card className="grid gap-1 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                  ...
                  <p className="text-muted-foreground">
                    Browse our extensive list of verified pandits. Filter by
                    service, location, or language to find the perfect match for
                    your ceremony.
                  </p>
                </CardContent>
              </Card>
              <Card className="grid gap-1 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                 <div className="rounded-full bg-primary/20 p-4">
                  ...
                  <p className="text-muted-foreground">
                    Review detailed profiles, including specializations,
                    experience, and photos. Contact them directly to discuss your needs.
                  </p>
                </CardContent>
              </Card>
              <Card className="grid gap-1 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                <CardContent className="p-6 flex flex-col items-center text-center gap-4">
                 <div className="rounded-full bg-primary/20 p-4">
                  ...
                  <p className="text-muted-foreground">
                    Finalize details and book your pandit. Enjoy a spiritually fulfilling
                    ceremony conducted by a trusted professional.
                  </p>
                </CardContent>
              </Card>
            </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Meet some of our highly-rated and experienced pandits, ready
                  to assist you with your spiritual journey.
                </p>
              </div>
            </div>
